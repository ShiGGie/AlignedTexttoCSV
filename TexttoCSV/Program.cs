...
namespace CSVConverterConsole
{
    class Program
    {
        ...
        private static void ProcessFile(string input, string output, int numHeaderLines, int dataFormat, int primaryKey, string[] delim)
        {
            ...
            Convertor convertor = new Convertor(textFile, csvFile);
            convertor.Run();
        }
